...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.5-alpha.1`** (GitHub tag, 2026-09-09 को सत्यापित: पूर्ण गेट श्रृंखला + प्रोफ़ाइल इंस्टॉल स्मोक)। npm निर्भरता लाइन `0.1.2-rc.1` और `0.1.5-alpha.1` (peer निर्भरताएँ `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`)。 |
...
- `typecheck` स्थानीय harness चेकआउट से `@deepseek-ai/*` हल करता है; `typecheck:ci` प्रकाशित `0.1.5-alpha.1` प्रकारों से जाँचता है।
