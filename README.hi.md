...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | `0.1.2-rc.1` (2026-09-04 को अनुकूलित; peer निर्भरताएँ ≥ 0.1.0-rc.8): सत्र लिफ़ाफ़ा अपना ignorable फ़ील्ड केवल संग्रहीत-लॉग पठन संगतता के लिए रखता है - Session.append अभी भी इसे स्टैम्प नहीं कर सकता, इसलिए गेट व्यवहार अपरिवर्तित है। |
...
- `typecheck` स्थानीय harness चेकआउट से `@deepseek-ai/*` हल करता है; `typecheck:ci` प्रकाशित `0.1.2-rc.1` प्रकारों से जाँचता है।
