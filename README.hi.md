...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | `0.1.1-rc.2` (peer निर्भरताएँ ≥ 0.1.0-rc.8; 2026-08-30 को checkout `0.1.2-alpha.2` से सत्यापित) 0.1.2-alpha.2 (2026-08-31 को अनुकूलित): सत्र लिफ़ाफ़ा अपना ignorable फ़ील्ड केवल संग्रहीत-लॉग पठन संगतता के लिए रखता है - Session.append अभी भी इसे स्टैम्प नहीं कर सकता, इसलिए गेट व्यवहार अपरिवर्तित है। |
