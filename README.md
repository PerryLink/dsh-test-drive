...
| Component | Version |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.7-rc.2`** (GitHub tag, verified 2026-09-11: full gate chain + profile install smoke). npm dependency lines `0.1.2-rc.1` and `0.1.7-rc.2` (peer dependencies `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`) |
...
```json
{
  ...
  "run": { "runId": "tdr_9f2c...", "startedAt": "2026-08-16T00:00:00.000Z",
           ...
           "harnessVersion": "0.1.7-rc.2", "pluginVersion": "0.3.13",
...
- `typecheck` resolves `@deepseek-ai/*` through the local harness checkout; `typecheck:ci` checks against the published `0.1.7-rc.2` types.
