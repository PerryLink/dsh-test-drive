...
[![dshfind](https://dshfind.com/api/badge/PerryLink/dsh-test-drive?metric=downloads&lang=zh)](https://dshfind.com/zh/plugins/PerryLink/dsh-test-drive?ref=badge)
...
| 组件 | 版本 |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.7-rc.1`**（GitHub tag，2026-09-24 已核验：完整门禁链 + profile 安装冒烟）。npm 依赖线 `0.1.2-rc.1` 与 `0.1.5-rc.2`（peer 依赖 `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`）。 |
