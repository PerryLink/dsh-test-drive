...
| Componente | Versión |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.5-rc.1`** (etiqueta de GitHub, verificado el 2026-09-10: cadena completa de puertas + smoke de instalación de perfil). Líneas de dependencia npm `0.1.2-rc.1` y `0.1.5-rc.1` (dependencias entre pares `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`). |
...
- `typecheck` resuelve `@deepseek-ai/*` a través del checkout local del harness; `typecheck:ci` comprueba contra los tipos publicados `0.1.5-rc.1`.
