...
| Componente | Versión |
|---|---|
| DeepSeek Harness | `0.1.1-rc.2` (dependencias peer ≥ 0.1.0-rc.8; verificado contra el checkout `0.1.2-alpha.2` el 2026-08-30) 0.1.2-alpha.2 (adaptado el 2026-08-31): el sobre de sesión conserva su campo ignorable solo para compatibilidad de lectura de logs almacenados - Session.append aún no puede estamparlo, por lo que el comportamiento de la puerta no cambia. |
