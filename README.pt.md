...
| Componente | Versão |
|---|---|
| DeepSeek Harness | `0.1.0-rc.8` (dependências peer ≥ 0.1.0-rc.8) |
...
- `typecheck` resolve `@deepseek-ai/*` pelo checkout local do harness; `typecheck:ci` verifica contra os tipos publicados `0.1.0-rc.8`.
