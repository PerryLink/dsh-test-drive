...
| Componente | Versão |
|---|---|
| DeepSeek Harness | **`dsh-v0.1.7-rc.2`** (tag do GitHub, verificado em 2026-09-11: cadeia completa de portas + smoke de instalação de perfil). Linhas de dependência npm `0.1.2-rc.1` e `0.1.7-rc.2` (dependências de pares `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0`). |
...
- `typecheck` resolve `@deepseek-ai/*` pelo checkout local do harness; `typecheck:ci` verifica contra os tipos publicados `0.1.7-rc.2`.
